...
low = setv(params, 'low_filter', 10, int) 
...
# MPM Model
up = True
dist0 = MPMDist(trn_data0,kmax=1,priorkappa=90,lammove=0.01,mumove=0.18,d=10.0,usepriors=up)
dist1 = MPMDist(trn_data1,kmax=1,priorkappa=90,lammove=0.01,mumove=0.18,d=10.0,usepriors=up)
